        ...
        <div class="hospital-list" id="hospitalList">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (isset($_POST['id']) && !empty($_POST['id'])) {
                    ...
                    $sql = "UPDATE place_info SET request_status=0 WHERE id=$id";
            ...
            $sql = "SELECT * FROM place_info WHERE request_status=1";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<button type="submit" class="btn-change-status" style="background-color: #007bff; border: 1px solid white; color: white; padding: 10px; text-decoration: none; margin-right: 10px;">Remove</button>';
                    echo '</form>';
